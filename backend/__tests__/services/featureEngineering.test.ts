import { aggregate_daily_features, compute_materiality_weighted_avg, compute_event_one_hot_weighted } from '../../src/services/featureEngineering';
import { StockPrice, ArticleSentiment } from '../../src/types/prediction.types';
