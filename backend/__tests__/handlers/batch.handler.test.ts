...
jest.unstable_mockModule('../../src/handlers/stocks.handler', () => ({
  handlePricesRequest: mockHandlePricesRequest,
}));

jest.unstable_mockModule('../../src/handlers/news.handler', () => ({
  handleNewsWithCache: mockHandleNewsWithCache,
}));

jest.unstable_mockModule('../../src/handlers/sentiment.handler', () => ({
...
jest.unstable_mockModule('../../src/utils/response.util', () => ({
  successResponse: mockSuccessResponse,
  errorResponse: mockErrorResponse,
}));

jest.unstable_mockModule('../../src/utils/metrics.util', () => ({
  logMetrics: jest.fn(),
  MetricUnit: {
