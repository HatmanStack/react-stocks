import { initializeDatabase, getDatabase, closeDatabase } from '../../../../frontend/src/database/database';
import { getDatabase as getWebDatabase, resetDatabase as resetWebDatabase } from '../../../../frontend/src/database/database.web';
