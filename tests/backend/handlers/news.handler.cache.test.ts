...
import { handleNewsRequest } from '../../../backend/src/handlers/news.handler';
import type { FinnhubNewsArticle } from '../../../backend/src/types/finnhub.types';

// Mock the repositories and services
import * as newsCacheRepo from '../../../backend/src/repositories/newsCache.repository';
import * as finnhubService from '../../../backend/src/services/finnhub.service';
...
jest.mock('../../../backend/src/services/finnhub.service', () => ({
...
describe('News Handler Integration Tests', () => {
  ...
  describe('Cache Miss Flow', () => {
    ...
    it.skip('should fetch from API when cache has fewer than 10 articles', async () => {
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should cache empty cache scenario', async () => {
  ...
  describe('Cache Hit Flow', () => {
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should return cached data when cache has >= 10 articles in date range', async () => {
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should transform cached data to correct Finnhub format', async () => {
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should filter articles by date range', async () => {
      const cachedItems = [
  ...
  describe('Duplicate Article Prevention', () => {
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should filter out duplicate articles when caching', async () => {
      mockQueryArticlesByTicker.mockResolvedValue([]);
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should generate consistent hashes for articles', async () => {
      mockQueryArticlesByTicker.mockResolvedValue([]);
  ...
  describe('Response Format', () => {
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should sort articles by date descending', async () => {
      const cachedItems = [
        {
          ticker: 'AAPL',
          articleHash: 'hash1',
