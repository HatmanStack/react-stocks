...
import { handleStocksRequest } from '../../../backend/src/handlers/stocks.handler';
import type { TiingoStockPrice, TiingoSymbolMetadata } from '../../../backend/src/types/tiingo.types';
import type { StockCacheItem } from '../../../backend/src/repositories/stocksCache.repository';
...
jest.mock('../../../backend/src/services/tiingo.service', () => ({
  fetchStockPrices: mockFetchStockPrices,
  fetchSymbolMetadata: mockFetchSymbolMetadata,
}));

jest.mock('../../../backend/src/repositories/stocksCache.repository', () => ({
...
describe('Stocks Handler', () => {
  ...
  describe('Valid Requests', () => {
    ...
    it.skip('should fetch stock prices successfully', async () => {
      const mockPrices = [
        {
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should fetch stock prices without end date', async () => {
      const mockPrices = [{
        date: '2024-01-01T00:00:00.000Z',
        open: 100,
        high: 100,
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should fetch symbol metadata successfully', async () => {
      const mockMetadata = {
        ticker: 'AAPL',
        name: 'Apple Inc.',
        exchangeCode: 'NASDAQ',
  ...
  describe('Service Error Propagation', () => {
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should propagate service errors with correct status codes', async () => {
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should return 500 for service errors without status code', async () => {
  ...
  describe('CORS Headers', () => {
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should include CORS headers in successful responses', async () => {
      mockFetchStockPrices.mockResolvedValue([]);
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should include CORS headers in error responses', async () => {
      const event = createMockEvent({});
