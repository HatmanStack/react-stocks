...
import type { TiingoStockPrice } from '../../../backend/src/types/tiingo.types';

// Mock the repositories and services
import * as stocksCacheRepo from '../../../backend/src/repositories/stocksCache.repository';
import * as tiingoService from '../../../backend/src/services/tiingo.service';
...
describe('Stocks Handler Integration Tests', () => {
  ...
  describe('Cache Miss Flow', () => {
    ...
    it.skip('should fetch from API when cache is empty and cache the result', async () => {
      // Setup: Empty cache
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should handle cache miss without endDate parameter', async () => {
      mockQueryStocksByDateRange.mockResolvedValue([]);
  ...
  describe('Cache Hit Flow', () => {
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should return cached data when cache hit rate > 80%', async () => {
