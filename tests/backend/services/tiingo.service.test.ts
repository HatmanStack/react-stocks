...
import { fetchStockPrices, fetchSymbolMetadata } from '../../../backend/src/services/tiingo.service';
...
describe('Tiingo Service', () => {
  ...
  describe('fetchStockPrices', () => {
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should retry on 429 rate limit error', async () => {
      const axiosError = {
        isAxiosError: true,
        response: { status: 429 },
      };
    ...
    // TODO: Fix ES modules + Jest mocking (GitHub issue #7)
    it.skip('should retry on 500 server error', async () => {
      const axiosError = {
        isAxiosError: true,
        response: { status: 500 },
      };
